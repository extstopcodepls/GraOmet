...
public class LevelCompleteWindow extends Sprite
{
    ...
    private void attachStars(VertexBufferObjectManager pSpriteVertexBufferObject)
    {
        ...
        scoreText = new Text(325, 50, ResourcesManager.getInstance().font, "Total score: " + LevelScoreCollector.getAllScore(), ResourcesManager.getInstance().vbom);
    ...
    public void display(StarsCount starsCount, Scene scene, Camera camera)
    {
        ...
        scoreText.setText("Score: " + LevelScoreCollector.getAllScore());
